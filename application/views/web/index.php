		...
		<aside id="colorlib-hero" class="colorlib-degree-bg">
			<div class="flexslider">
				<ul class="slides">
					<li style="background-image: url(<?php echo base_url() ?>assets/web/images/blog-2.jpg);">
					...
					<li style="background-image: url(<?php echo base_url() ?>assets/web/images/yogacara-b23.jpg);">
						<div class="overlay"></div>
						<div class="container-fluid">
							<div class="row">
								<div class="col-md-6 col-sm-12 col-xs-12 col-md-offset-3 slider-text">
					...
					<li style="background-image: url(<?php echo base_url() ?>assets/web/images/yogacara-b3.jpg);">
						<div class="overlay"></div>
						<div class="container-fluid">
							<div class="row">
								<div class="col-md-6 col-sm-12 col-xs-12 col-md-offset-3 slider-text">
					...
					<div class="col-md-6">
						<div class="row">
							<div class="col-md-12 animate-box">
								<div class="services-img" style="background-image: url(<?php echo base_url() ?>assets/web/images/classes-1.jpg);"></div>
							</div>
							<div class="col-md-6 animate-box">
								<div class="services-img" style="background-image: url(<?php echo base_url() ?>assets/web/images/classes-2.jpg);"></div>
							</div>
							<div class="col-md-6 animate-box">
								<div class="services-img" style="background-image: url(<?php echo base_url() ?>assets/web/images/classes-3.jpg);"></div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-3 col-sm-3 col-xs-6 text-center animate-box">
						<div class="product-entry">
							<div class="product-img" style="background-image: url(<?php echo base_url() ?>assets/web/images/item-1.jpg);">
								<div class="cart">
									<p>
					...
					<div class="col-md-3 col-sm-3 col-xs-6 text-center animate-box">
						<div class="product-entry">
							<div class="product-img" style="background-image: url(<?php echo base_url() ?>assets/web/images/item-2.jpg);">
								<div class="cart">
									<p>
										<span class="addtocart"><a href="#"><i class="icon-cart"></i></a></span>
										<span><a href="#"><i class="icon-eye"></i></a></span>
					...
					<div class="col-md-3 col-sm-3 col-xs-6 text-center animate-box">
						<div class="product-entry">
							<div class="product-img" style="background-image: url(<?php echo base_url() ?>assets/web/images/item-3.jpg);">
								<div class="cart">
									<p>
										<span class="addtocart"><a href="#"><i class="icon-cart"></i></a></span>
										<span><a href="#"><i class="icon-eye"></i></a></span>
					...
					<div class="col-md-3 col-sm-3 col-xs-6 text-center animate-box">
						<div class="product-entry">
							<div class="product-img" style="background-image: url(<?php echo base_url() ?>assets/web/images/item-4.jpg);">
								<div class="cart">
									<p>
										<span class="addtocart"><a href="#"><i class="icon-cart"></i></a></span>
										<span><a href="#"><i class="icon-eye"></i></a></span>
		...
		<div id="colorlib-counter" class="colorlib-counters colorlib-degree-bg" style="background-image: url(<?php echo base_url() ?>assets/web/images/intro-img-1.jpg);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
				...
				<div class="row animate-box">
					<div class="owl-carousel">
						<div class="item">
							<div class="col-md-12 text-center">
								<div class="trainers-entry">
									<div class="trainer-img" style="background-image: url(<?php echo base_url() ?>assets/web/images/trainer-1.jpg)"></div>
									<div class="desc">
										<h3>Diego Carter</h3>
						...
						<div class="item">
							<div class="col-md-12 text-center">
								<div class="trainers-entry">
									<div class="trainer-img" style="background-image: url(<?php echo base_url() ?>assets/web/images/trainer-2.jpg)"></div>
									<div class="desc">
										<h3>Lea Young</h3>
						...
						<div class="item">
							<div class="col-md-12 text-center">
								<div class="trainers-entry">
									<div class="trainer-img" style="background-image: url(<?php echo base_url() ?>assets/web/images/trainer-3.jpg)"></div>
									<div class="desc">
										<h3>Alysha Reed</h3>
						...
						<div class="item">
							<div class="col-md-12 text-center">
								<div class="trainers-entry">
									<div class="trainer-img" style="background-image: url(<?php echo base_url() ?>assets/web/images/trainer-4.jpg)"></div>
									<div class="desc">
										<h3>George Cooper</h3>
		...
		<div id="colorlib-testimony" class="testimony-img" style="background-image: url(<?php echo base_url() ?>assets/web/images/img_bg_2.jpg);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
						...
						<div class="testimony-flex">
							<div class="one-fifth animate-box">
								<div class="testimony-wrap">
									...
									<div class="desc">
										<div class="figure-img" style="background-image: url(<?php echo base_url() ?>assets/web/images/person1.jpg);"></div>
							...
							<div class="one-fifth animate-box">
								<div class="testimony-wrap">
									...
									<div class="desc">
										<div class="figure-img" style="background-image: url(<?php echo base_url() ?>assets/web/images/person2.jpg);"></div>
										<h3>Dave Henderson</h3>
									</div>
								</div>
							</div>
							<div class="one-fifth animate-box">
								<div class="testimony-wrap">
									...
									<div class="desc">
										<div class="figure-img" style="background-image: url(<?php echo base_url() ?>assets/web/images/person3.jpg);"></div>
										<h3>Dave Henderson</h3>
									</div>
								</div>
							</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4 text-center animate-box">
						<div class="classes">
							<div class="classes-img" style="background-image: url(<?php echo base_url() ?>assets/web/images/classes-1.jpg);">
					...
					<div class="col-md-4 text-center animate-box">
						<div class="classes">
							<div class="classes-img" style="background-image: url(<?php echo base_url() ?>assets/web/images/classes-2.jpg);">
								<p class="price text-center"><span>$25.00<br><small>/month</small></span></p>
							</div>
							<div class="desc">
					...
					<div class="col-md-4 text-center animate-box">
						<div class="classes">
							<div class="classes-img" style="background-image: url(<?php echo base_url() ?>assets/web/images/classes-3.jpg);">
								<p class="price text-center"><span>$25.00<br><small>/month</small></span></p>
							</div>
							<div class="desc">
				...
				<div class="row">
					<div class="col-md-4 animate-box">
						<article class="article-entry">
							<a href="blog.html" class="blog-img" style="background-image: url(<?php echo base_url() ?>assets/web/images/blog-1.jpg);">
					...
					<div class="col-md-4 animate-box">
						<article class="article-entry">
							<a href="blog.html" class="blog-img" style="background-image: url(<?php echo base_url() ?>assets/web/images/blog-2.jpg);">
								<p class="meta"><span class="day">18</span><span class="month">May</span></p>
							</a>
							<div class="desc">
								<p class="admin"><span>Posted by:</span> <span>Noah Henderson</span></p>
					...
					<div class="col-md-4 animate-box">
						<article class="article-entry">
							<a href="blog.html" class="blog-img" style="background-image: url(<?php echo base_url() ?>assets/web/images/blog-3.jpg);">
								<p class="meta"><span class="day">18</span><span class="month">May</span></p>
							</a>
							<div class="desc">
								<p class="admin"><span>Posted by:</span> <span>Noah Henderson</span></p>
		...
		<div class="colorlib-gallery">
			...
			<div class="row">
				<div class="col-md-12 animate-box">
					<a href="images/classes-1.jpg" class="gallery-img image-popup" style="background-image: url(<?php echo base_url() ?>assets/web/images/classes-1.jpg);">
						<span class="icon"><i class="icon-plus2"></i></span>
					</a>
					<a href="images/classes-2.jpg" class="gallery-img image-popup" style="background-image: url(<?php echo base_url() ?>assets/web/images/classes-2.jpg);">
						<span class="icon"><i class="icon-plus2"></i></span>
					</a>
					<a href="images/classes-3.jpg" class="gallery-img image-popup" style="background-image: url(<?php echo base_url() ?>assets/web/images/classes-3.jpg);">
						<span class="icon"><i class="icon-plus2"></i></span>
					</a>
					<a href="images/classes-4.jpg" class="gallery-img image-popup" style="background-image: url(<?php echo base_url() ?>assets/web/images/classes-4.jpg);">
						<span class="icon"><i class="icon-plus2"></i></span>
					</a>
					<a href="images/classes-5.jpg" class="gallery-img image-popup" style="background-image: url(<?php echo base_url() ?>assets/web/images/classes-5.jpg);">
						<span class="icon"><i class="icon-plus2"></i></span>
					</a>
					<a href="images/classes-6.jpg" class="gallery-img image-popup" style="background-image: url(<?php echo base_url() ?>assets/web/images/classes-6.jpg);">
						<span class="icon"><i class="icon-plus2"></i></span>
					</a>
					<a href="images/classes-7.jpg" class="gallery-img image-popup" style="background-image: url(<?php echo base_url() ?>assets/web/images/classes-7.jpg);">
						<span class="icon"><i class="icon-plus2"></i></span>
					</a>
					<a href="images/classes-8.jpg" class="gallery-img image-popup" style="background-image: url(<?php echo base_url() ?>assets/web/images/classes-8.jpg);">
						<span class="icon"><i class="icon-plus2"></i></span>
					</a>
					<a href="images/classes-9.jpg" class="gallery-img image-popup" style="background-image: url(<?php echo base_url() ?>assets/web/images/classes-9.jpg);">
						<span class="icon"><i class="icon-plus2"></i></span>
					</a>
					<a href="images/classes-1.jpg" class="gallery-img image-popup" style="background-image: url(<?php echo base_url() ?>assets/web/images/classes-1.jpg);">
						<span class="icon"><i class="icon-plus2"></i></span>
